...
class FacebookService implements InitializingBean, Serializable  {
  ...
  void afterPropertiesSet() {
	...
	this.nextPage = grailsApplication.config.facebook.url
  }
  ...
  def getFacebookConnection(request, response) {
    ...
    String nextPage = grailsApplication.config.facebook.url
